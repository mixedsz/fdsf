IPLS = {
	{
		...
		interiorsProps = { 'meth_lab_security_high', 'meth_lab_upgrade' },
...
function loadInterior(coords, interiorProps, interiorsPropColors)
	for _, value in pairs(coords) do
		local interiorID = GetInteriorAtCoords(value[1], value[2], value[3])
