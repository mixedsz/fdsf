Zen.Config.Police = {
    ...
    Station = {
        [1] = {
            label = 'Armory',
            menu = 'armory',
            coords = vec3(452.8825, -770.5039, -76.8048)
        },
        [2] = {
            label = 'Boss Actions',
            menu = 'boss',
    ...
    Weapons = {
        ['weapon_pistol50'] = { 
            ...
            price = 1000, 
            ranks = { 'cadet', 'officer', 'corporal', 'sergeant', 'lieutenant', 'captain', 'major', 'assistant chief', 'chief of police' }
        },
        ['weapon_combatpdw'] = { 
    ...
    Items = {
        ...
        ['medkit'] = { 
            item = 'medkit', 
            price = 1000, 
            ranks = { 'cadet', 'officer', 'corporal', 'lieutenant', 'captain', 'major', 'assistant chief', 'chief of police' }
        },
    },
    ...
    Vehicles = {
        ...
        { 
            ...
            label = 'Kalamo',
            price = 1, 
            ranks = { 'lieutenant', 'captain', 'major', 'assistant chief', 'chief of police' }
        },
        { 
            model = 'nkscout', 
            label = 'PD Scout',
    ...
    Helicopters = {
        { 
            ...
            price = 1000, 
            ranks = { 'captain', 'major', 'assistant chief', 'chief of police' }
        },
    },
